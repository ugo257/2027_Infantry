...
inertial_ff = min(max(inertial_ff, ...
    ...
    cfg.limits.inertial_feedforward_limit_nm);
generalized_ff = terms_ref.coriolis_nm + terms_ref.gravity_generalized_nm + ...
    terms_ref.viscous_nm + terms_ref.coulomb_generalized_nm;
...
known_nonlinear_accel = -(terms.coriolis_nm + ...
    terms.gravity_generalized_nm + terms.coulomb_generalized_nm) / ...
    terms.inertia;
